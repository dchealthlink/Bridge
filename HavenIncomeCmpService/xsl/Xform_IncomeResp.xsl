...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [TUE OCT 03 14:43:39 EDT 2017]. -->
?>
    ...
    <db1:incomes>
      ...
      <xsl:for-each select="$IncomeFormat/incomes/income">
        <db1:income>
          ...
          <db1:inc_statuscode>
            <xsl:value-of select="inc_statuscode"/>
          </db1:inc_statuscode>
          <db1:inc_receiveddate>
            <xsl:value-of select="inc_receiveddate"/>
          </db1:inc_receiveddate>
          <db1:inc_correctionsetid>
            <xsl:value-of select="inc_correctionsetid"/>
          </db1:inc_correctionsetid>
        </db1:income>
      </xsl:for-each>
    </db1:incomes>

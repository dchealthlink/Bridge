...
<?oracle-xsl-mapper
  ...
  <mapSources>
    <source type="WSDL">
      <schema location="../InvokePregnancyDetSP.wsdl"/>
      <rootElement name="OutputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/sp/InvokePregnancyDetSP"/>
    </source>
    <source type="WSDL">
      <schema location="../HavenPregnancyDetailsCmpServiceABCSImpl.wsdl"/>
      <rootElement name="participant_pregnant" namespace="https://openhbx.gov/haven/Pregnancydetails/spformat"/>
      <param name="FormatSPOutput" />
    </source>
  </mapSources>
  <mapTargets>
    <target type="WSDL">
      <schema location="../HavenPregnancyDetailsCmpServiceABCSImpl.wsdl"/>
      <rootElement name="participant_pregnant" namespace="https://openhbx.gov/haven/Pregnancyedetails/response"/>
    </target>
  </mapTargets>
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [FRI DEC 01 15:32:26 EST 2017]. -->
?>
<xsl:stylesheet version="1.0"
                ...
                xmlns:tns="http://xmlns.oracle.com/pcbpel/adapter/db/Test/HavenPregnancyDetailsCmpService/InvokePregnancyDetSP"
                ...
                xmlns:db="http://xmlns.oracle.com/pcbpel/adapter/db/sp/InvokePregnancyDetSP"
                xmlns:bpel="http://docs.oasis-open.org/wsbpel/2.0/process/executable"
                xmlns:ldap="http://schemas.oracle.com/xpath/extension/ldap"
                exclude-result-prefixes="xsl xsi xsd plt client ns2 ns3 tns plnk ns1 wsdl db oraext socket ora bpws xdk ids mhdr bpm xp20 hwf xref dvm med bpel ldap">

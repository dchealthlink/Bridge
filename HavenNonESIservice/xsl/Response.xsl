...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.8(build 150622.2350.0222) AT [MON OCT 17 11:33:47 EDT 2016]. -->
?>
<xsl:stylesheet version="1.0" xmlns:ns6="http://vnem.ee.sim.dsh.cms.hhs.gov"
  ...
  <xsl:template match="/">
    <imp1:VerifyNonESIMECResponse>
      ...
      <imp1:HavenId>
        <xsl:value-of select="/imp1:VerifyNonESIMECRequest/imp1:IndividualRequest/imp1:HavenId"/>
      </imp1:HavenId>
      <imp1:RequestNumber>
        <xsl:value-of select="/imp1:VerifyNonESIMECRequest/imp1:IndividualRequest/imp1:RequestNumber"/>
      </imp1:RequestNumber>
    </imp1:VerifyNonESIMECResponse>
  </xsl:template>
</xsl:stylesheet>

...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [WED FEB 22 11:49:16 EST 2017]. -->
?>
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/">
    <imp1:APTCResponse>
      ...
      <ns3:RequestNumber>
        <xsl:value-of select="$ReceiveInput_InputVariable.body/imp1:APTCRequest/ns3:RequestNumber"/>
      </ns3:RequestNumber>

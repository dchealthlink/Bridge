...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [WED FEB 22 11:51:40 EST 2017]. -->
?>
      ...
      <xsl:for-each select="/imp1:APTCResponse/ns3:ErrorMessageDetail">
        <ns3:ErrorMessageDetail>
          ...
          <ns0:ResponseMetadata>
            ...
            <ns0:ResponseCode>
              <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode/@ns1:id">
                <xsl:attribute name="ns1:id">
                  <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode/@ns1:id"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode/@ns1:metadata">
                <xsl:attribute name="ns1:metadata">
                  <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode/@ns1:metadata"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode/@ns1:linkMetadata">
                <xsl:attribute name="ns1:linkMetadata">
                  <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode/@ns1:linkMetadata"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseCode"/>
            </ns0:ResponseCode>
            <ns0:ResponseDescriptionText>
              <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText/@ns1:id">
                <xsl:attribute name="ns1:id">
                  <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText/@ns1:id"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText/@ns1:metadata">
                <xsl:attribute name="ns1:metadata">
                  <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText/@ns1:metadata"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText/@ns1:linkMetadata">
                <xsl:attribute name="ns1:linkMetadata">
                  <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText/@ns1:linkMetadata"/>
                </xsl:attribute>
              </xsl:if>
              <xsl:value-of select="translate(/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:ResponseDescriptionText,&quot;'&quot;,&quot;&quot;)"/>
            </ns0:ResponseDescriptionText>
            <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText">
              <ns0:TDSResponseDescriptionText>
                <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText/@ns1:id">
                ...
                <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText/@ns1:metadata">
                  <xsl:attribute name="ns1:metadata">
                    <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText/@ns1:metadata"/>
                  </xsl:attribute>
                </xsl:if>
                <xsl:if test="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText/@ns1:linkMetadata">
                  <xsl:attribute name="ns1:linkMetadata">
                    <xsl:value-of select="/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText/@ns1:linkMetadata"/>
                  </xsl:attribute>
                </xsl:if>
                <xsl:value-of select="translate(/imp1:APTCResponse/ns3:ErrorMessageDetail/ns0:ResponseMetadata/ns0:TDSResponseDescriptionText,&quot;'&quot;,&quot;&quot;)"/>
              </ns0:TDSResponseDescriptionText>
            </xsl:if>
          </ns0:ResponseMetadata>

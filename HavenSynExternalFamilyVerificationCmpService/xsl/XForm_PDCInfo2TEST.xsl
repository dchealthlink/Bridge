            ...
            <integrated_case>
               ...
               <curam_applicants>
                  <xsl:for-each select="curam_applicants/curam_applicant">
                     <curam_applicant>
                        ...
                        <tax_dependents>
                           <xsl:if test="tax_dependents/tax_dependent">
               ...
               <product_delivery_cases>
                  <xsl:for-each select="product_delivery_cases/product_delivery_case">
                     <xsl:variable name="pdc_case_ref" select="pdc_case_reference"/>
                     <xsl:choose>
                        <xsl:when test="pdc_case_reference = $PDCInfo/integratedcases/integratedcase/product_delivery_cases/product_delivery_case/product_delivery_case_reference">
                           <product_delivery_case>
                              ...
                              <pdc_start_date>
                                 <xsl:value-of select="$PDCInfo/integratedcases/integratedcase/product_delivery_cases/product_delivery_case[(product_delivery_case_reference = $pdc_case_ref)]/effectivedate"/>
                              </pdc_start_date>
                              <pdc_effective_date>
                                 <xsl:value-of select="$PDCInfo/integratedcases/integratedcase/product_delivery_cases/product_delivery_case[(product_delivery_case_reference = $pdc_case_ref)]/startdate"/>
                              </pdc_effective_date>
                              <pdc_expected_end_date>
                                 <xsl:value-of select="$PDCInfo/integratedcases/integratedcase/product_delivery_cases/product_delivery_case[(product_delivery_case_reference = $pdc_case_ref)]/expectedenddate"/>
                              </pdc_expected_end_date>
                                       ...
                                       <xsl:when test="concern_role_id = $PDCInfo/integratedcases/integratedcase/product_delivery_cases/product_delivery_case[(product_delivery_case_reference = $pdc_ref)]/concern_role_id">
                                          <pdc_applicant>
                                             ...
                                             <appl_consent_created_on>
                                                <xsl:value-of select="appl_consent_created_on"/>
                                             </appl_consent_created_on>
                                             <renewal_base_year>
                                                <xsl:value-of select="renewal_base_year"/>
                                             </renewal_base_year>

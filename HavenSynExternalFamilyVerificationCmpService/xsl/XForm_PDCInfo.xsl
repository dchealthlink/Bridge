            ...
            <integrated_case>
               ...
               <product_delivery_cases>
                  <xsl:for-each select="product_delivery_cases/product_delivery_case">
                     <xsl:choose>
                        <xsl:when test="pdc_case_reference = $PDCInfo/ns2:integratedcases/ns2:integrated_case/ns2:product_delivery_cases/ns2:product_delivery_case/ns2:product_delivery_case_reference">
                           <product_delivery_case>
                              ...
                              <pdc_applicants>
                                 <xsl:for-each select="pdc_applicants/pdc_applicant">
                                    ...
                                    <xsl:choose>
                                       <xsl:when test="concern_role_id = $PDCInfo/ns2:integratedcases/ns2:integrated_case/ns2:product_delivery_cases/ns2:product_delivery_case[ns2:product_delivery_case_reference = $pdc_ref]/ns2:concern_role_id">
                                          <pdc_applicant>
                                             <xsl:if test="person_id">
                                                <person_id>
                                                   <xsl:value-of select="person_id"/>

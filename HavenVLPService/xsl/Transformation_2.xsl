      ...
      <imp1:verifyLawfulPresenceOutput>
         <imp1:responseMetadata>
            ...
            <imp1:responseDescriptionText>
               <xsl:value-of select="/imp1:verifyLawfulPresenceOutput/imp1:responseMetadata/imp1:responseDescriptionText"/>
            </imp1:responseDescriptionText>
            <xsl:if test="/imp1:verifyLawfulPresenceOutput/imp1:responseMetadata/imp1:TDSResponseDescriptionText">
               <imp1:TDSResponseDescriptionText>
                  <xsl:value-of select="/imp1:verifyLawfulPresenceOutput/imp1:responseMetadata/imp1:TDSResponseDescriptionText"/>
               </imp1:TDSResponseDescriptionText>
            </xsl:if>
            <imp1:RequestNumber>
               <xsl:value-of select="/imp1:verifyLawfulPresenceOutput/imp1:responseMetadata/imp1:RequestNumber"/>
            </imp1:RequestNumber>
            <imp1:PersonID>
               <xsl:value-of select="/imp1:verifyLawfulPresenceOutput/imp1:responseMetadata/imp1:PersonID"/>
            </imp1:PersonID>
         </imp1:responseMetadata>
      </imp1:verifyLawfulPresenceOutput>
   </xsl:template>
